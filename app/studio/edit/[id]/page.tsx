...
export default function AdminEditor() {
    ...
    const uploadConfigFile = useCallback(async (file: File, fileType: 'audio' | 'xml' | 'midi') => {
        ...
        // Normalize content type — browser file.type for .xml is unreliable
        // (can be empty, 'text/xml', or 'application/vnd.recordare.musicxml')
        // which causes OSMD to try parsing plain XML as a ZIP-compressed MXL file.
